  ...
  render() {
    return (
      <div className="purpose">
            ...
            <Container>
              ...
              <Col md="3">
                <Table hover>
                  <tbody>
                    <tr  >
                      <td id="kid-photo" onClick={(e) => this.handleSelectItem(e)} >Unser Bild vom Kind</td>
                    </tr>

                    <tr>
                      <td id="bi-language" onClick={(e) =>this.handleSelectItem(e)}>Zweisprachig von Anfang an</td>
                    </tr>

                    <tr>
                      <td id="edu-game" onClick={(e) =>this.handleSelectItem(e)}>Situationsansatz</td>
                    </tr>

                    <tr>
                      <td id="free-game" onClick={(e) =>this.handleSelectItem(e)}>Freispiel / Angebot</td>
                    </tr>

                    <tr>
                      <td id="kita-garten" onClick={(e) =>this.handleSelectItem(e)}>Vorschule</td>
                    </tr>

                    <tr>
                      <td id="edu-programm" onClick={(e) =>this.handleSelectItem(e)}>Berliner Bildungsprogramm</td>
                    </tr>

                    <tr>
                      <td id="parent-partener" onClick={(e) =>this.handleSelectItem(e)}>Eltern als Partner</td>
                    </tr>

                    <tr>
                      <td id="dev-process" onClick={(e) =>this.handleSelectItem(e)}>Beobachtung und Dokumentation von Entwicklungsschritten</td>
                    </tr>

                    <tr>
                      <td id="train-recorder" onClick={(e) =>this.handleSelectItem(e)}>Eingewöhnung</td>
                    </tr>
                  </tbody>
                </Table>
              </Col>
        ...
        {!this.props.isGerman && (<div className="chinese"></div>)}
