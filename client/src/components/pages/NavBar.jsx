        ...
        <Navbar expand="md">
          ...
          <Collapse isOpen={this.state.isOpen} navbar> 
            <Nav className="ml-auto" navbar>
              ...
              <NavItem>
                <NavLink to="/life">{this.props.isGerman? 'Kitaleben':'幼儿园生活'}</NavLink>
              </NavItem>
              <NavItem>
                <NavLink to="/purpose">{this.props.isGerman? 'Konzept':'办园心声'}</NavLink>
              </NavItem>
              <NavItem>
                <NavLink to="/registration">{this.props.isGerman? 'Anmeldung':'登记入园'}</NavLink>
              </NavItem>
              <NavItem>
                {api.isLoggedIn() && api.isManager() && <NavLink to="/signup">{this.props.isGerman? 'Signup': '注册'}</NavLink>}
              </NavItem> 
              <NavItem>
              ...
              <NavItem>
                <NavLink to="/contact">{this.props.isGerman? 'Kontakt':'联系我们'}</NavLink>
              </NavItem>            
            </Nav>
          </Collapse>
        </Navbar>
