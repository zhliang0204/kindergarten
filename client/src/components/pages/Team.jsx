      ...
      <div className="Team outer-div">
        {this.props.isGerman && (<div className="german">
          ...
          <div className="teachers">
            <div className="content-header">Die Erzieher</div>
            <div className="tiger-teaches">
              <div className="teacher-header">Tigergruppe:</div>
              ...
              <div className="teacher">
                <div className="teacher-image"><img src={profileImage} alt="image of teacher"/></div>
                <div className="teacher-intro">
            ...
            <div className="dragon-teaches">
              <div className="teacher-header">Drachengruppe:</div>
              <div className="teacher">
                <div className="teacher-image"><img src={profileImage} alt="image of teacher"/></div>
                <div className="teacher-intro">
          ...
          <div className="dean">
            <div className="content-header">Die Kitaleitung</div>
            <div>Seit August 2014 übernimmt Nadine bei uns die Position der pädagogischen Leitung.</div>
          </div>

          <div className="support">
            <div className="content-header">Der Vorstand</div>
