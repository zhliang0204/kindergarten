          ...
          {this.state.event && (<div>
            ...
            {this.state.tag !== 2 && (
              ...
              {this.state.tag > 0 && (<div className="vote">
                <div className="event-status-detail-title" style={{cursor:"pointer"}}  onClick={() => this.voteToggle()}>
                  <div >Vote</div>
              ...
              {this.state.tag === 2 && (<div className="stop">
                <div className="event-status-detail-title" style={{cursor:"pointer"}}  onClick={() => this.stopToggle()}>
                  <div >Stop</div>
              ...
              <div className="event-status-detail-title" style={{cursor:"pointer"}} onClick={() => this.applyToggle()}>
                  <div >Apply</div>
              ...
              <div className="event-status-detail-title" style={{cursor:"pointer"}} onClick={() => this.processToggle()}>
                  <div >Process</div>
              ...
              {this.state.tag > 4 && (
                <div>
                  <div className="event-status-detail-title" style={{cursor:"pointer"}} onClick={() => this.finishToggle()}>
                    <div >Finish</div>
